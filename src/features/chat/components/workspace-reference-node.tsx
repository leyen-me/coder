...
export function WorkspaceReferenceNodeView({
  ...
  return (
    <NodeViewWrapper as="span" className="inline">
      <span
        className={cn(
          "mx-0.5 inline-flex max-w-full items-center gap-1 rounded-full border bg-muted/50 py-0.5 pr-0.5 pl-1.5 align-middle text-xs font-mono text-foreground leading-none",
