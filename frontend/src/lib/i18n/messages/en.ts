...
export const enMessages = {
  ...
  sidebar: {
    ...
    exportChatJsonSuccess: "Full session data exported",
    exportChatJsonFailed: "Failed to export full session data",
  ...
  chat: {
    ...
    enhancePromptStop: "Stop enhancing",
  ...
  settings: {
    ...
    general: {
      ...
      autoGenerateTitlesLabel: "Auto-generate session titles",
      autoGenerateTitlesDescription: "Use the model to generate a title for each new session; off by default (title is taken from your first message)",
      autoGenerateTitlesAriaLabel: "Auto-generate session titles",
    ...
    modelProvider: {
      ...
      customProvidersSectionTitle: "Custom providers",
      addProviderButton: "Add custom provider",
      customProviderDefaultName: "Custom provider",
      customProviderNamePlaceholder: "e.g. My Ollama / OpenAI",
      customProviderNameAriaLabel: "Custom provider name",
      removeProviderAriaLabel: "Delete this custom provider",
      confirmRemoveProviderTitle: "Delete custom provider?",
      confirmRemoveProviderDescription: "This removes \"{name}\" and all of its configured models. This cannot be undone.",
      confirmRemoveProviderAction: "Delete",
