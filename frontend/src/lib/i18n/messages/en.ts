...
export const enMessages = {
  ...
  chat: {
    ...
    compactInProgress: "Writing a handoff note for the next model…",
    ...
    compactViewSummary: "View handoff",
    compactHideSummary: "Hide summary",
    compactSuccess: "Replaced {removedCount} earlier messages with a handoff note.",
  ...
  settings: {
    ...
    general: {
      ...
      titleSourceLabel: "Session title source",
      titleSourceDescription: "How new sessions get their title",
      titleSourceAriaLabel: "Session title source",
      titleSourceFirstMessage: "First message",
      titleSourceModel: "Generated by model",
