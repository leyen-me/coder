...
export const zhMessages = {
  ...
  chat: {
    ...
    compactInProgress: "正在生成交接说明（Handoff）…",
    ...
    compactViewSummary: "查看交接说明",
    compactHideSummary: "收起摘要",
    compactSuccess: "已将 {removedCount} 条历史消息替换为交接说明。",
  ...
  settings: {
    ...
    general: {
      ...
      titleSourceLabel: "会话标题来源",
      titleSourceDescription: "新会话标题的生成方式",
      titleSourceAriaLabel: "会话标题来源",
      titleSourceFirstMessage: "首条消息截取",
      titleSourceModel: "模型生成",
